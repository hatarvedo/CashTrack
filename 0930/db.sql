...
ADD CONSTRAINT `fk_kiadasok1` FOREIGN KEY (`felhasznalo_id`) REFERENCES `users` (`id`),
ADD CONSTRAINT `fk_kiadasok3` FOREIGN KEY (`kategoria_id`) REFERENCES `kiadas_kategoriak` (`kategoria_id`);

ALTER TABLE `jovedelem`
ADD KEY `kategoria_id` (`kategoria_id`),
ADD KEY `felhasznalo_id`(`felhasznalo_id`),
ADD CONSTRAINT `fk_jovedelem_2` FOREIGN KEY (`felhasznalo_id`) REFERENCES `users` (`id`);
